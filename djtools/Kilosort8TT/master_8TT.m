...
addpath(genpath('C:\Users\lab\Documents\KiloSort')) % path to kilosort folder
addpath(genpath('C:\Users\lab\Documents\npy-matlab')) % path to npy-matlab scripts
pathToYourConfigFile = 'C:\Users\lab\Documents\Kilosort8TT'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
