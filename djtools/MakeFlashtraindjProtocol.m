...
for rep=1:nrepeats
    for n=1:numicis
        ...
        stimuli(n).param.VarLaserstart=0;
        stimuli(n).param.VarLaserpulsewidth= flashduration;
        stimuli(n).param.VarLasernumpulses=nflashes;
        stimuli(n).param.VarLaserisi=icis(n);
