function [filename,path]=MakeSoundfileSeamlessdjProtocol(amplitude, dur, include_whitenoise, interleave_laser, include_silent_sound, isi, nrepeats)
...
next = -2000;    % trying this value for seamless
...
for nreps=1:nrepeats
    for i = 1:numsoundfiles
        ...
        sourcefilename=sprintf('SNDfile_%s_SRCfile_%s_%d_%ddB_%.1fs.mat', descriptname, fn, i, amp, durations(i));
        cd(sourcepath_wd)
