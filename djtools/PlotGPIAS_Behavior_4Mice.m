...
%     ProcessGPIAS_BehaviorTilt(datadir,4); 
    ProcessGPIAS_Behavior4Mice(datadir,4);
end
...
for outindex=1:length(d)
    ...
    if isfield(out, 'mouseID') & strcmp(out.outfilename, 'outGPIAS_Behavior.mat')
        mouseID=out.mouseID;
    elseif isfield(out, 'mouseID') & strcmp(out.outfilename, 'outGPIAS_BehaviorMouse2.mat')
        mouseID=out.mouseID;
    elseif isfield(out, 'mouseID') & strcmp(out.outfilename, 'outGPIAS_BehaviorMouse3.mat')
        mouseID=out.mouseID;
    elseif isfield(out, 'mouseID') & strcmp(out.outfilename, 'outGPIAS_BehaviorMouse4.mat')
        mouseID=out.mouseID;
    else mouseID='???';
    end
