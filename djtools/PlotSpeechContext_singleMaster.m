function PlotSpeechContext_singleMaster(varargin)
...
rasters=1;
force_reprocess=0;
plot_switch = 0;                                                           % Override switch to ignore generating plots when initially creating outfiles - SFM 8/12/22
...
if exist(outfilename,'file')
    ...
    ProcessSoundfile_singleMaster(datadir,  t_filename, xlimits, ylimits);
    load(fullfile(datadir, outfilename));
end
