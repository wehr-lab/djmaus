...
while run
    ...
    if ~dataloaded % plot title screen
        ...
        e=2; H=e;
        w=100; h=25;
        SP.BatchPreph=uicontrol(gcf,'tag','BatchPrep','style','pushbutton','units','pixels',...
            'fontsize',10,'fontname','Arial', 'enable', 'on',...
            'string', 'Batch Prep',  'callback', 'BatchPrep','horiz','left','pos',[e H w h ]);
