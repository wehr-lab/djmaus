...
%from within the same diredctory as that mex file. If that doesn't work you
...
fprintf('\nNote that this does not check to see if open-ephys actually received any of those messages. ')
